# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-10-05 15:43
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('delay', models.IntegerField(blank=True, default=None, help_text='[!]: This feature is ONLY available when you have a DONATOR account for PVOutput.org! Leave EMPTY to disable the feature. This parameter allows the processing of the data to be delayed, by the specified number of minutes. Allowed values: empty or 0 to 120 (minutes)', null=True, validators=[django.core.validators.MinValueValidator(0), django.core.validators.MaxValueValidator(120)], verbose_name='PVOutput: Delay')),
